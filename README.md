...
3. **Run the development servers:** _(Specific commands will be added as Nx apps are generated)._
...
8. **Merge:** Once approved and checks pass, the PR is merged via _Squash and Merge_ to keep the history clean.
