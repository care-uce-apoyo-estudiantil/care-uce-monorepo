...
export const AlertsPage: React.FC = () => {
  return (
    <AdminTemplate>
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-gray-800">Registro de Alertas</h2>
        <p className="text-gray-500">Historial y creación de nuevas alertas tempranas.</p>
      </div>
      <div className="bg-white p-12 rounded-xl shadow-sm border border-gray-100 text-center">
        ...
        <p className="text-gray-500 mt-1">El formulario de registro manual estará disponible próximamente.</p>
      </div>
    </AdminTemplate>
  );
};