    ...
    <div className="flex flex-col h-full bg-white">
      <header className="h-16 border-b flex items-center justify-between px-8 bg-slate-50 shrink-0">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-lg font-bold text-slate-800">Active Emergency Channels</h2>
        </div>
        ...
        <div className="w-1/3 border-r bg-slate-50 overflow-y-auto">
          <div className="p-4 border-b bg-red-50/50 cursor-pointer hover:bg-red-50">
            <div className="flex justify-between items-center mb-1">
              <h4 className="font-bold text-slate-800">Anonymous Student #842</h4>
              <span className="text-xs font-bold text-red-600">Now</span>
            </div>
            <p className="text-sm text-slate-600 truncate">Panic button activated. Geolocation attached.</p>
          </div>
        </div>
          ...
          <div className="flex-1 p-6 overflow-y-auto bg-slate-100/50 space-y-4">
            <div className="flex justify-start">
              <div className="bg-white border border-red-200 p-4 rounded-lg shadow-sm max-w-md">
                <p className="text-sm font-bold text-red-600 mb-1">SYSTEM ALERT</p>
                <p className="text-sm text-slate-700">Panic button triggered from Engineering Faculty. High heart rate detected via telemetry.</p>
              </div>
            </div>
            <div className="flex justify-end">
              <div className="bg-teal-600 text-white p-4 rounded-lg shadow-sm max-w-md">
                <p className="text-sm">Hello. I am the clinical psychologist on duty. Are you safe right now? We are sending protocol support.</p>
              </div>
            </div>
          </div>
